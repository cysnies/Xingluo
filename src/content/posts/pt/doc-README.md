---
title: "Documentação do Xingluo"
pubDatetime: 2026-06-20T02:00:00+08:00
description: "Visão geral da documentação do projeto Xingluo com navegação, recursos principais e stack tecnológico."
tags:
  - documentation
  - xingluo
...
| Documento                                           | Conteúdo                                                                                 |
| --------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| [Começando](./doc-getting-started.md)               | Requisitos, instalação, desenvolvimento local, build e preview                           |
| [Guia de configuração](./doc-configuration.md)      | Referência completa para `xingluo.config.ts`                                             |
| [Criação de conteúdo](./doc-content.md)             | Frontmatter de posts, sintaxe Markdown/MDX, blocos de código, callouts, melhorias        |
| [Internacionalização](./doc-i18n.md)                | Roteamento multilíngue, strings de UI, tradução em nível de conteúdo, adicionar idioma   |
| [Visão geral da arquitetura](./doc-architecture.md) | Estrutura de diretórios, fluxo de configuração, fluxo de renderização, pipeline de build |
| [Tema e estilos](./doc-theming.md)                  | Variáveis de tema shadcn, OKLCH, Tailwind v4, modo escuro                                |
| [Sistema de comentários](./doc-comments.md)         | Escolha e configuração de giscus / twikoo / waline                                       |
| [Reprodutores de mídia](./doc-media-players.md)     | Uso de APlayer / DPlayer em Markdown e MDX                                               |
| [SEO](./doc-seo.md)                                 | Imagens OG, RSS, sitemap, hreflang, canonical, dados estruturados                        |
| [Pesquisa](./doc-search.md)                         | Integração de busca de texto completo Flexsearch                                         |
| [Implantação](./doc-deployment.md)                  | Hospedagem estática, GitHub Pages, variáveis de ambiente, Docker                         |
