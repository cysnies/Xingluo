...
description: "Guía para iniciar Xingluo para desarrollo local y compilaciones de producción, que cubre requisitos, instalación, desarrollo y despliegue."
tags:
  - documentation
  - getting-started
...
- Lee la [Guía de configuración](./doc-configuration.md) para personalizar la información del sitio y las funciones
- Lee [Creación de contenido](./doc-content.md) para empezar a escribir
- Lee [Despliegue](./doc-deployment.md) para publicar tu sitio
