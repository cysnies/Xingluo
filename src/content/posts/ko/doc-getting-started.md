...
description: "Xingluo를 로컬 개발 및 프로덕션 빌드용으로 시작하는 가이드 - 요구 사항, 설치, 개발 및 배포."
tags:
  - documentation
  - getting-started
...
- [설정 가이드](./doc-configuration.md)를 읽고 사이트 정보 및 기능 토글을 사용자 정의하세요
- [콘텐츠 작성](./doc-content.md)을 읽고 글쓰기를 시작하세요
- [배포](./doc-deployment.md)를 읽고 사이트를 공개하세요
