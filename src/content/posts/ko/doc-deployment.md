...
description: "Xingluo 배포 가이드 - 정적 호스팅 플랫폼(Netlify/Vercel/GitHub Pages), Nginx 자체 호스팅, Docker 및 환경 변수."
tags:
  - documentation
  - deployment
...
| 변수                              | 설명                                      |
| --------------------------------- | ----------------------------------------- |
| `PUBLIC_GOOGLE_SITE_VERIFICATION` | Google Search Console 확인 값 (선택 사항) |
...
5. `public/favicon.svg`가 사이트 아이콘으로 교체되었는지 확인
...
| 댓글 시스템 | 백엔드 요구 사항                                                                                             |
| ----------- | ------------------------------------------------------------------------------------------------------------ |
| giscus      | 없음; giscus.app 공개 서비스 사용(또는 자체 호스팅 [giscus-vercel](https://github.com/giscus/giscus-vercel)) |
| twikoo      | twikoo 서버 배포(Vercel / CloudBase / 자체 호스팅)                                                           |
| waline      | waline 서버 배포(Vercel / Cloudflare / 자체 호스팅)                                                          |

각 댓글 시스템의 공식 문서 및 [댓글 시스템](./doc-comments.md) 참조.
