...
description: "Guide to bootstrap Xingluo for local development and production builds, covering requirements, installation, dev, and deployment."
tags:
  - documentation
  - getting-started
...
- Read the [Configuration Guide](./doc-configuration.md) to customize site info and feature toggles
- Read [Content Authoring](./doc-content.md) to start writing
- Read [Deployment](./doc-deployment.md) to publish your site
