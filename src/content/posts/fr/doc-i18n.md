...
description: "Détails du système i18n de Xingluo couvrant le routage multilingue, la localisation des chaînes UI, la traduction au niveau du contenu et l'ajout de nouvelles langues."
tags:
  - documentation
  - i18n
...
- Les articles dans une locale non par défaut ont un canonical pointant vers l'original dans la locale par défaut (pour éviter les pénalités de contenu en double ; voir [SEO](./doc-seo.md))
...
2. **Traduction** : placez-la dans un sous-répertoire de langue `src/content/posts/<locale>/<slug>.md`, en utilisant le même `translationKey` :
