...
description: "Référence complète de toutes les options de configuration de Xingluo, incluant la configuration du site, des articles, les fonctionnalités, les liens sociaux, les liens de partage et les variables d'environnement."
tags:
  - documentation
  - configuration
...
site: {
  ...
  description: "Un CMS de blog moderne construit avec Astro et shadcn",
...
| `mdx`              | `true`             | Activer l'analyse et le rendu MDX (voir [Rédaction de contenu](./doc-content.md))             |
| `comments`         | `{provider:false}` | Configuration du système de commentaires (voir [Système de commentaires](./doc-comments.md))  |
| `players.aplayer`  | `false`            | Activer le lecteur audio APlayer (voir [Lecteurs multimédia](./doc-media-players.md))         |
...
Ces entrées de partage apparaissent en bas des pages d'articles. `url` est un préfixe d'URL de partage ; Xingluo ajoute l'URL absolue de l'article courant. `name` correspond de même à une icône dans `src/assets/icons/socials/`.
