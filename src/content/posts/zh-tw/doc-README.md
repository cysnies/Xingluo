...
description: "星羅（Xingluo）專案文件總覽，包含文件導航、核心特性介紹與技術棧說明。"
tags:
  - documentation
  - xingluo
...
| 文件                                 | 內容                                                              |
| ------------------------------------ | ----------------------------------------------------------------- |
| [快速開始](./doc-getting-started.md) | 環境要求、安裝、本機開發、構建與預覽                              |
| [設定指南](./doc-configuration.md)   | `xingluo.config.ts` 全部設定項詳解                                |
| [內容創作](./doc-content.md)         | 文章 frontmatter、Markdown/MDX 語法、程式碼區塊、標註框、內容增強 |
| [國際化](./doc-i18n.md)              | 多語言路由策略、UI 文案、內容級翻譯、新增語言                     |
| [架構總覽](./doc-architecture.md)    | 目錄結構、設定流、渲染流、構建流程                                |
| [主題與樣式](./doc-theming.md)       | shadcn 主題變數、OKLCH、Tailwind v4、暗色模式                     |
