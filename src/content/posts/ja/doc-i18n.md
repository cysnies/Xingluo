...
description: "Xingluo 国際化システムの詳細。多言語ルーティング戦略、UI 文字列のローカライゼーション、コンテンツレベルの翻訳、新しい言語の追加方法をカバーします。"
tags:
  - documentation
  - i18n
...
- 非デフォルトロケールの投稿は canonical がデフォルトロケールのオリジナルを指す（重複コンテンツペナルティを回避。詳細は [SEO](./doc-seo.md) を参照）
