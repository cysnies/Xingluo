...
description: "Xingluo デプロイガイド。静的ホスティングプラットフォーム（Netlify/Vercel/GitHub Pages）、Nginx セルフホスティング、Docker、環境変数をカバーします。"
tags:
  - documentation
  - deployment
...
- Pagefind インデックスはオンデマンドで読み込まれるため、特別なキャッシュ戦略は不要
...
各コメントシステムの公式ドキュメントと[コメントシステム](./doc-comments.md)を参照。
