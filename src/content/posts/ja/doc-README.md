---
title: "Xingluo ドキュメント"
pubDatetime: 2026-06-20T02:00:00+08:00
description: "Xingluo プロジェクトドキュメントの概要。ドキュメントナビゲーション、コア機能、テクノロジースタックの説明を含みます。"
tags:
  - documentation
  - xingluo
...
| ドキュメント                                 | 内容                                                                            |
| -------------------------------------------- | ------------------------------------------------------------------------------- |
| [はじめに](./doc-getting-started.md)         | 要件、インストール、ローカル開発、ビルドとプレビュー                            |
| [設定ガイド](./doc-configuration.md)         | `xingluo.config.ts` の完全リファレンス                                          |
| [コンテンツ作成](./doc-content.md)           | 投稿のフロントマター、Markdown/MDX 構文、コードブロック、コールアウト、拡張機能 |
| [国際化](./doc-i18n.md)                      | 多言語ルーティング、UI 文字列、コンテンツレベルの翻訳、言語の追加               |
| [アーキテクチャ概要](./doc-architecture.md)  | ディレクトリ構成、設定フロー、レンダリングフロー、ビルドパイプライン            |
| [テーマとスタイル](./doc-theming.md)         | shadcn テーマ変数、OKLCH、Tailwind v4、ダークモード                             |
