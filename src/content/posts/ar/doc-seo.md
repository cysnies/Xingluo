...
description: "دليل تحسين محركات البحث SEO في Xingluo ويغطي Open Graph وبطاقة Twitter و canonical والبيانات المنظمة JSON-LD و RSS وخريطة الموقع."
tags:
  - documentation
  - seo
...
`<head>` في [`src/layouts/Layout.astro`](../src/layouts/Layout.astro) يخرج:
...
يُولد `sitemap-index.xml` وإعلانات بديلة لكل لغة؛ `robots.txt` يشير إلى خريطة الموقع.
