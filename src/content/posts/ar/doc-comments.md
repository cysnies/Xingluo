...
description: "دليل نظام التعليقات في Xingluo ويغطي اختيار وتكوين ودمج giscus و twikoo و waline."
tags:
  - documentation
  - comments
...
features: {
  comments: {
    ...
    giscus: { /* إعدادات giscus */ },
    // twikoo: { /* إعدادات twikoo */ },
    // waline: { /* إعدادات waline */ },
  },
}
```
