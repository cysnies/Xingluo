...
description: "دليل نشر Xingluo ويغطي منصات الاستضافة الثابتة (Netlify/Vercel/GitHub Pages) والاستضافة الذاتية Nginx و Docker ومتغيرات البيئة."
tags:
  - documentation
  - deployment
...
- فهارس Pagefind تُحمّل عند الطلب؛ لا حاجة لاستراتيجية تخزين مؤقت خاصة
...
انظر وثائق كل نظام تعليقات و [نظام التعليقات](./doc-comments.md).
