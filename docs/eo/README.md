...
| Dokumento                                     | Enhavo                                                                    |
| --------------------------------------------- | ------------------------------------------------------------------------- |
| [Komenci](./getting-started.md)               | Postuloj, instalo, loka evoluigo, konstruo kaj antaŭrigardo               |
| [Agorda gvidilo](./configuration.md)          | Plena referenco por `xingluo.config.ts`                                   |
| [Enhava kreado](./content.md)                 | Afiŝa frontmatter, Markdown/MDX-sintakso, kodblokoj, callouts, plibonigoj |
| [Internaciigo](./i18n.md)                     | Plurlingva vojigo, UI-ĉenoj, traduko je enhava nivelo, aldoni lingvon     |
| [Arkitektura superrigardo](./architecture.md) | Dosieruja strukturo, agorda fluo, bildiga fluo, konstrutubo               |
| [Etoso kaj stiloj](./theming.md)              | shadcn-etosaj variabloj, OKLCH, Tailwind v4, malhela reĝimo               |
