...
| [Content Authoring](./content.md)          | Post frontmatter, Markdown/MDX syntax, code blocks, callouts, enhancements     |
| [Internationalization](./i18n.md)          | Multilingual routing, UI strings, content-level translation, adding a language |
...
| [Search](./search.md)                      | Flexsearch full-text search integration                                        |
| [Deployment](./deployment.md)              | Static hosting, GitHub Pages, environment variables, Docker                    |
