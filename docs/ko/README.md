...
| 문서                                  | 내용                                                               |
| ------------------------------------- | ------------------------------------------------------------------ |
| [시작하기](./getting-started.md)      | 요구 사항, 설치, 로컬 개발, 빌드 및 미리보기                       |
| [설정 가이드](./configuration.md)     | `xingluo.config.ts` 전체 참조                                      |
| [콘텐츠 작성](./content.md)           | 게시물 프론트매터, Markdown/MDX 구문, 코드 블록, 콜아웃, 향상 기능 |
| [국제화](./i18n.md)                   | 다국어 라우팅, UI 문자열, 콘텐츠 수준 번역, 언어 추가              |
| [아키텍처 개요](./architecture.md)    | 디렉터리 구조, 설정 흐름, 렌더링 흐름, 빌드 파이프라인             |
| [테마 및 스타일](./theming.md)        | shadcn 테마 변수, OKLCH, Tailwind v4, 다크 모드                    |
| [댓글 시스템](./comments.md)          | giscus / twikoo / waline 선택 및 연결                              |
| [미디어 플레이어](./media-players.md) | Markdown 및 MDX에서 APlayer / DPlayer 사용                         |
| [SEO](./seo.md)                       | OG 이미지, RSS, 사이트맵, hreflang, canonical, 구조화된 데이터     |
| [검색](./search.md)                   | Flexsearch 전체 텍스트 검색 통합                                   |
| [배포](./deployment.md)               | 정적 호스팅, GitHub Pages, 환경 변수, Docker                       |
