...
- مقالات اللغات غير الافتراضية لها canonical يشير إلى الأصل باللغة الافتراضية (لتجنب عقوبات المحتوى المكرر؛ انظر [تحسين محركات البحث](./seo.md))
...
انظر [تحسين محركات البحث](./seo.md).
