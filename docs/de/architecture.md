...
3. **`node scripts/generateSearchIndex.mjs`**: scannt HTML-Dateien in `dist/`, analysiert Seiteninhalte und generiert sprachspezifische Suchindizes in `dist/search/`
